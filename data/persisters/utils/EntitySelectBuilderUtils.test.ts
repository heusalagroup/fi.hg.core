...
import { EntitySelectBuilderUtils } from "./EntitySelectBuilderUtils";
...
describe('EntitySelectBuilderUtils', () => {
    ...
    describe('#includeEntityFields', () => {
        ...
        it('calls the correct methods on the builder for each field type', () => {
            ...
            EntitySelectBuilderUtils.includeEntityFields(builder, tableName, fields, temporalProperties);

            expect(builder.includeColumnAsTimestamp).toHaveBeenCalledWith(tableName, 'date_time');
            expect(builder.includeColumnAsTimestamp).toHaveBeenCalledTimes(1);

            expect(builder.includeColumnAsText).toHaveBeenCalledWith(tableName, 'string_column');
