...
export const typeJsonTests = (context : RepositoryTestContext) : void => {
    ...
    describe('Delete', () => {
        ...
        describe('#deleteAll', () => {
            ...
            it('can delete few entities with an array of entities', async () => {
    ...
    describe.skip('Between', () => {
        ...
        describe('#countByDataJsonBetween', () => {
            ...
            it('can count entities by dataId', async () => {
    ...
    // TODO: Skipped: We don't have reliable solution to implement before query for the whole JSON object or array.
    ...
    // TODO: Skipped: We don't have reliable solution to implement after query for the whole JSON object or array.
    describe.skip('After', () => {
