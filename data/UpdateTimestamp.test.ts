...
describe('UpdateTimestamp', () => {
    ...
    it('cannot set creation timestamp metadata for barDate property', () => {
        expect(metadata.creationTimestamps).toBeArray();
        expect(metadata.creationTimestamps).not.toContainEqual("barDate");
    });
    ...
    it('cannot set update timestamp metadata for barDate property', () => {
        expect(metadata.updateTimestamps).toBeArray();
        expect(metadata.updateTimestamps).not.toContainEqual("barDate");
    });

    it('cannot set update timestamp metadata for barUpdated property', () => {
        expect(metadata.updateTimestamps).toBeArray();
        expect(metadata.updateTimestamps).toContainEqual("barUpdated");
    });
