...
import { explainWpUserProfileListDTO, isWpUserProfileListDTO, WpUserProfileListDTO } from "./WpUserProfileListDTO";
...
describe('WpUserProfileListDTO', () => {

    describe('isWpUserProfileListDTO', () => {
        it('can test array of DTOs', () => {
            expect(isWpUserProfileListDTO(TEST_PROFILES)).toBe(true);
        });
    });

    describe('explainWpUserProfileListDTO', () => {
        it('can test array of DTOs', () => {
            expect(explainWpUserProfileListDTO(TEST_PROFILES)).toBe(explainOk());
        });
    });
