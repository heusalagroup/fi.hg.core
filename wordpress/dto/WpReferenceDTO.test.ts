...
import { explainWpReferenceDTO, isWpReferenceDTO } from "./WpReferenceDTO";
...
describe('WpReferenceDTO', () => {

    describe('isWpReferenceDTO', () => {
        it('can test valid DTOs', () => {
            expect( isWpReferenceDTO(TEST_REFERENCE_DATA[0]) ).toBe(true);
            expect( isWpReferenceDTO(TEST_REFERENCE_DATA[1]) ).toBe(true);
            expect( isWpReferenceDTO(TEST_REFERENCE_DATA[2]) ).toBe(true);
            expect( isWpReferenceDTO(TEST_REFERENCE_DATA[3]) ).toBe(true);
            expect( isWpReferenceDTO(TEST_REFERENCE_DATA[4]) ).toBe(true);
            expect( isWpReferenceDTO(TEST_REFERENCE_DATA[5]) ).toBe(true);
        });
    });

    describe('explainWpReferenceDTO', () => {
        it('can explain valid DTOs', () => {
            expect( explainWpReferenceDTO(TEST_REFERENCE_DATA[0]) ).toBe(explainOk());
            expect( explainWpReferenceDTO(TEST_REFERENCE_DATA[1]) ).toBe(explainOk());
            expect( explainWpReferenceDTO(TEST_REFERENCE_DATA[2]) ).toBe(explainOk());
            expect( explainWpReferenceDTO(TEST_REFERENCE_DATA[3]) ).toBe(explainOk());
            expect( explainWpReferenceDTO(TEST_REFERENCE_DATA[4]) ).toBe(explainOk());
            expect( explainWpReferenceDTO(TEST_REFERENCE_DATA[5]) ).toBe(explainOk());
        });
    });
