...
import { explainWpPostListDTO, isWpPostListDTO } from "./WpPostListDTO";
...
describe('WpPostListDTO', () => {

    describe('isWpPostListDTO', () => {
        it('can test valid DTOs', () => {
            expect( isWpPostListDTO(TEST_DATA_POSTS) ).toBe(true);
        });
    });

    describe('explainWpPostListDTO', () => {
        it('can explain valid DTOs', () => {
            expect( explainWpPostListDTO(TEST_DATA_POSTS) ).toBe(explainOk());
        });
    });
