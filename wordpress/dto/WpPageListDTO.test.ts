...
describe('WpPageListDTO', () => {

    describe('isWpPageListDTO', () => {
        it('can test valid list', () => {
            expect( isWpPageListDTO(TEST_DATA_PAGES) ).toBe(true);
        });
    });

    describe('explainWpPageListDTO', () => {
        it('can explain valid list', () => {
            expect( explainWpPageListDTO(TEST_DATA_PAGES) ).toBe(explainOk());
        });
    });
