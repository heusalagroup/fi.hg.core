...
import { OpenAiChatCompletionMessageDTO, createOpenAiChatCompletionMessageDTO, isOpenAiChatCompletionMessageDTO, explainOpenAiChatCompletionMessageDTO } from "./OpenAiChatCompletionMessageDTO";
...
describe("OpenAiChatCompletionMessageDTO", () => {
    ...
    describe("createOpenAiChatCompletionMessageDTO", () => {
        ...
        it("createOpenAiChatCompletionMessageDTO throws an error if frequency_penalty is not a number", () => {

        });

        it("createOpenAiChatCompletionMessageDTO throws an error if presence_penalty is not a number", () => {
    ...
    describe("isOpenAiChatCompletionMessageDTO", () => {
        ...
        it("returns false for invalid OpenAiChatCompletionMessageDTO objects", () => {
