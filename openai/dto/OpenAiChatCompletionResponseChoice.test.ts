...
import { OpenAiChatCompletionResponseChoice, createOpenAiChatCompletionResponseChoice, isOpenAiChatCompletionResponseChoice, explainOpenAiChatCompletionResponseChoice } from "./OpenAiChatCompletionResponseChoiceDTO";
...
describe("OpenAiChatCompletionResponseChoice", () => {
    ...
    describe("createOpenAiChatCompletionResponseChoice", () => {
        ...
        it("createOpenAiChatCompletionResponseChoice throws an error if frequency_penalty is not a number", () => {

        });

        it("createOpenAiChatCompletionResponseChoice throws an error if presence_penalty is not a number", () => {
